...
namespace Salary.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public TipoUsuariosController(SalaryDiagContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoUsuario,Nombre")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoUsuario,Nombre")] TipoUsuario tipoUsuario)
        {

...
namespace Salary.Controllers
{
    public class CiudadsController : Controller
    {
        ...
        public CiudadsController(SalaryDiagContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCiudad,Ciudad1,IdProvincia,Latitud,Longitud")] Ciudad ciudad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCiudad,Ciudad1,IdProvincia,Latitud,Longitud")] Ciudad ciudad)
        {
